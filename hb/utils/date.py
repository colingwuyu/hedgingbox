...
def get_period_str_from_time(period: float) -> str:
    ...
    Returns:
        str: period in string
            1W, 2W, 3W, 4W, 5W, 6W, 7W, 2M, 3M, 4M, 5M, 6M, 7M, 8M, 9M, 1Y
    """
    if abs(period - 7./360.) < 1e-5:
        return '1W'
    if abs(period - 14./360.) < 1e-5:
        return '2W'
    if abs(period - 21./360.) < 1e-5:
        return '3W'
    if abs(period - 30./360.) < 1e-5:
        return '4W'
    if abs(period - 37./360.) < 1e-5:
        return '5W'
    if abs(period - 44./360.) < 1e-5:
        return '6W'
    if abs(period - 51./360.) < 1e-5:
        return '7W'
    if abs(period - 60./360.) < 1e-5:
        return '2M'
    if abs(period - 90./360.) < 1e-5:
        return '3M'
    if abs(period - 120./360.) < 1e-5:
        return '4M'
    if abs(period - 150./360.) < 1e-5:
        return '5M'
    if abs(period - 180./360.) < 1e-5:
        return '6M'
    if abs(period - 210./360.) < 1e-5:
        return '7M'
    if abs(period - 240./360.) < 1e-5:
        return '8M'
    if abs(period - 270./360.) < 1e-5:
        return '9M'
